...
cmf1931 = cmfs_data.iloc[:, 11:15].to_numpy()[:-30]
...
plt.title("CF 2 DEGREE (730nm ~ 830nm STEP 10)", fontdict=font1)
...
plt.savefig('cf_2degree_730_830.svg', bbox_inches='tight', pad_inches=0.5)
plt.savefig('cf_2degree_730_830.png', bbox_inches='tight', pad_inches=0.5)
# plt.show()
