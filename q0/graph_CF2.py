...
plt.title("CF 2 DEGREE", fontdict=font1)
...
plt.savefig('cf_2degree.svg', bbox_inches='tight', pad_inches=0.5)
plt.savefig('cf_2degree.png', bbox_inches='tight', pad_inches=0.5)
# plt.show()
