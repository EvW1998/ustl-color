...
plt.title("CMF 1964 (730nm ~ 830nm STEP 5)", fontdict=font1)
...
for i in range(len(cmf1931_x[-101::5])):
    x = cmf1931_x[-101::5][i]
    y = cmf1931_y[-101::5][i]
    text = str(co[-101::5][i]) + "nm"
    texts.append(plt.text(x, y, text, color="red", fontsize=12))

plt.savefig('cmf1964_730_830.svg', bbox_inches='tight', pad_inches=0.5)
plt.savefig('cmf1964_730_830.png', bbox_inches='tight', pad_inches=0.5)
# plt.show()
